...
// =============================================================
// 13. UPDATE STATS (مساعد مالي ذكي)
// =============================================================
const ADVISOR = {
...
// =============================================================
// 18. 🔴 المزامنة الحيّة بين الأجهزة (تُضاف في النهاية)
// =============================================================
    ...
    try {
        ...
        if (ts > liveSeenTs + 2000) {
            ...
            tx.oncomplete = async () => {
                ...
                if (remote.data.currency) { currentCurrency = remote.data.currency; }
...
// ✔ دفع تلقائي عند كل إضافة / تعديل / حذف / إيداع / سحب
...
// ✔ فحص التغييرات القادمة من الأجهزة الأخرى كل 30 ثانية
